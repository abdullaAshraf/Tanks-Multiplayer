...
public class PlayerSetup : NetworkBehaviour {
    ...
    void Start () {
        ...
        if (!isLocalPlayer)
        {
            DisableComponents();
            AssignRemoteLayer();
            transform.Find("ViewVisualization").gameObject.SetActive(false);
    ...
    {
        GameManger.instance.setMatchSettigns(GetComponent<Player>().matchSettings);
        GameManger.SetLocalPlayer(transform.name);
